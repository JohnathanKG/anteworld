...
public:
    ...
    static const int HASHID = 1403908062u;
    ...
    static const coid::token& intergen_default_creator_static(backend bck) {
        static constexpr coid::token _dc("plugin_interface.get@1403908062"_T);
        static constexpr coid::token _djs("plugin_interface@wrapper.js"_T);
        static constexpr coid::token _djsc("plugin_interface@wrapper.jsc"_T);
        static constexpr coid::token _dlua("plugin_interface@wrapper.lua"_T);
...
inline iref<T> plugin_interface::get(T* _subclass_)
{
    ...
    static constexpr coid::token ifckey = "plugin_interface.get@1403908062"_T;
    ...
    if (!create) {
        log_mismatch("plugin_interface"_T, "plugin_interface.get"_T, "@1403908062"_T);
        return 0;
    }
...
inline auto plugin_interface::set_value(int x) -> void { return VT_CALL(void,(int),0)(x); }
inline auto plugin_interface::get_value() const -> int { return VT_CALL(int,() const,1)(); }
